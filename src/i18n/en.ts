export const en = {
  // Authentication
  auth: {
    loginTitle: 'Sign In to EvolveMe',
  ...
  dashboard: {
    ...
    aiTipsError: 'Sorry, could not fetch AI tips right now. Please try again later.',
    aiTipsRateLimitError: 'Too many requests. Please wait a moment before trying again.',
    resetConfirmation: 'Are you sure you want to reset all your progress? This will delete your selfie history and score.',
    ...
    scoreInfoButton: 'How is my score calculated?',
    scoreInfoTitle: 'How Your Score is Calculated',
    scoreInfoContent: `Your Evolve Score is generated by our advanced AI, which analyzes your selfie based on several factors relevant to your primary goal.\n\n- Skincare: The AI assesses skin clarity, texture, and signs of healthy skin.\n- Fitness: The analysis focuses on facial indicators of a healthy lifestyle.\n- Style: The AI evaluates grooming, personal presentation, and how well your attire suits you.\n- Confidence: The analysis looks for cues in your expression and posture that suggest self-assurance.\n\nThe score is a tool to track your progress over time. It's not a judgment, but a benchmark to help you on your self-improvement journey!`
  },
